...
// y = 160
    ...
    textAlign(LEFT);
    textSize(24);
    text('500 Cities: Prevelance Percentages of Asthma', 40, 50);
    text('& Lack of Sleep Among US Adults', 40, 85);
    // text('', 300, 90);
...
//     textAlign(CENTER);
//     textSize(24);
//     text('500 Cities: Asthma and Lack of Sleep Prevelance', 300, 50);
//     // text('', 300, 90);
